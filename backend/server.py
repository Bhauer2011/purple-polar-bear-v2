...
def default_data() -> dict:
    return {
        ...
        "menu_items": [
            MenuItem(name="Banana", emoji="\U0001F367").model_dump(),
            MenuItem(name="Black Cherry", emoji="\U0001F367").model_dump(),
            MenuItem(name="Blue Raspberry", emoji="\U0001F367").model_dump(),
            MenuItem(name="Bubble Gum", emoji="\U0001F367").model_dump(),
            MenuItem(name="Butter Beer", emoji="\U0001F367").model_dump(),
            MenuItem(name="Cherry", emoji="\U0001F367").model_dump(),
            MenuItem(name="Chocolate", emoji="\U0001F367").model_dump(),
            MenuItem(name="Coconut", emoji="\U0001F367").model_dump(),
            MenuItem(name="Cola", emoji="\U0001F367").model_dump(),
            MenuItem(name="Cotton Candy", emoji="\U0001F367").model_dump(),
            MenuItem(name="Egg Custard", emoji="\U0001F367").model_dump(),
            MenuItem(name="Fireball", emoji="\U0001F367").model_dump(),
            MenuItem(name="French Vanilla", emoji="\U0001F367").model_dump(),
            MenuItem(name="Grape", emoji="\U0001F367").model_dump(),
            MenuItem(name="Green Apple", emoji="\U0001F367").model_dump(),
            MenuItem(name="Gummy Bear", emoji="\U0001F367").model_dump(),
            MenuItem(name="Hawaiian Tutti Frutti", emoji="\U0001F367").model_dump(),
            MenuItem(name="Honeydew Melon", emoji="\U0001F367").model_dump(),
            MenuItem(name="Kiwi", emoji="\U0001F367").model_dump(),
            MenuItem(name="Lemon", emoji="\U0001F367").model_dump(),
            MenuItem(name="Lime", emoji="\U0001F367").model_dump(),
            MenuItem(name="Mango", emoji="\U0001F367").model_dump(),
            MenuItem(name="Orange", emoji="\U0001F367").model_dump(),
            MenuItem(name="Peach", emoji="\U0001F367").model_dump(),
            MenuItem(name="Pineapple", emoji="\U0001F367").model_dump(),
            MenuItem(name="Pink Lemonade", emoji="\U0001F367").model_dump(),
            MenuItem(name="Red Raspberry", emoji="\U0001F367").model_dump(),
            MenuItem(name="Root Beer", emoji="\U0001F367").model_dump(),
            MenuItem(name="Skylight", emoji="\U0001F367").model_dump(),
            MenuItem(name="Spearmint", emoji="\U0001F367").model_dump(),
            MenuItem(name="Strawberry", emoji="\U0001F367").model_dump(),
            MenuItem(name="Watermelon", emoji="\U0001F367").model_dump(),
        ],
        "event_requests": [],
        "notification_emails": [
